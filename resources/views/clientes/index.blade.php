      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          ...
          <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('cliente.create') }}" class="btn btn-sm btn-neutral">Nuevo Cliente</a>
    ...
    <table class="table align-items-center table-flush">
      <thead class="thead-light">
        <tr>
          ...
          <th scope="col" class="sort" data-sort="nombre">Correo</th>
          <th scope="col" class="sort" data-sort="nombre">Clave</th>
