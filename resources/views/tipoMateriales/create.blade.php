@extends('layouts.main', ['title' => __('Tipo Material')])
    ...
    <div class="card bg-secondary shadow">
        <div class="card-header bg-orange border-1">
            <div class="row align-items-center">
                <h3 class="mb-0">{{ __('Tipo Material') }}</h3>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('tipoMateriales.store') }}" method="post"   class="form-horizontal">
                @csrf


                <h6 class="heading-small text-muted mb-4">{{ __(' Formulario Tipo Material') }}</h6>
