<form action="{{ route('categorias.store')}}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="modal fade text-left" id="ModalCreat" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="pl-lg-4">
                        ...
                        <div class="text-center">
                            <a class="btn btn-danger mt-4"  href="{{ route('categorias.index') }}">{{ __('Volver') }}</a>
