@extends('layouts.main', ['class' => 'register-page', 'page' => _('Register Page'), 'contentClass' => 'register-page'])
        ...
        <div class="col-md-5 ml-auto">
            ...
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    ...
                    <p class="description">
                        <img src="{{ asset('img/anime3.png') }}" alt="">
            ...
            <div class="card card-register card-white">
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-warning btn-round btn-lg">{{ _('Get Started') }}</button>
                    </div>
                </form>
            </div>
        </div>
