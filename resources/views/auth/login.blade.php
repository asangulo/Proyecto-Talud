@extends('layouts.main', ['class' => 'login-page', 'page' => _('Login Page'), 'contentClass' => 'login-page'])

@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5"> Pasandola Sabroso </h3>
    </div>
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-footer">
                    <button type="submit" href="" class="btn btn-warning btn-lg btn-block mb-3">{{ _('Get Started') }}</button>
                    <div class="pull-left">
                        <h6>
