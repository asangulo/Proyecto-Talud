@extends('layouts.main', ['page' => __('EditarObra'), 'pageSlug' => 'EditarObra'])
            ...
            <div class="card">
                <div class="card">
                    <div class="card-header">
                        <h5 class="title">Editar Obra</h5>
                    </div>

                    <form action="{{ route('obras.update', $obra->id) }}" method="post"   class="form-horizontal">
                        @csrf
                        @method('PUT')
            ...
            <div class="card card-user">
                <div class="card-body">
                    ...
                    <p class="descripcion">
                         {{ $obra->estado}}   <br>
                         {{ $obra->descripcion }}   <br>
                        Fecha de creación: {{ $obra->created_at }}  <br>
